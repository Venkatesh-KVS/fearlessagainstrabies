  ...
  return (
    <Wrapper>
      <div className="PR-r1">
        ...
        <div className="PR-r2 d-flex flex-wrap">
          <div className="PR-box PR-c1 w-40">
          ...
          <div className="PR-box PR-c2 w-40">
          ...
          <div className="PR-box PR-c3 w-40">
          ...
          <div className="PR-box PR-c4 w-40">
